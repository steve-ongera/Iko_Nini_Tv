...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '1000/minute' if DEBUG else '200/day',
        'user': '2000/minute' if DEBUG else '1000/day',
    },
}
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@ikoninitv.com')
